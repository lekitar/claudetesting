      ...
      >
        <div className="relative rounded-3xl overflow-hidden backdrop-blur-xl bg-white/5 border border-white/10 shadow-2xl shadow-black/40 p-8">
          ...
          <motion.div initial={{ opacity: 0, x: -10 }} animate={{ opacity: 1, x: 0 }} transition={{ delay: 0.3 }} className="mb-8">
            ...
            <p className="text-white/50 text-sm">Accede a tu plataforma de evaluación de desempeño</p>
          </motion.div>
          ...
          <motion.form onSubmit={handleSubmit} initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ delay: 0.4 }} className="space-y-4">
            ...
            <div>
              <label className="block text-xs font-semibold mb-2 uppercase tracking-widest"
                style={{ color: focusedField === 'email' ? '#818cf8' : 'rgba(255,255,255,0.5)' }}>
                Correo electrónico
              </label>
            ...
            <div>
              <label className="block text-xs font-semibold mb-2 uppercase tracking-widest"
                style={{ color: focusedField === 'password' ? '#818cf8' : 'rgba(255,255,255,0.5)' }}>
                Contraseña
              </label>
              <div className="relative">
                <input
          ...
          <motion.button initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.65 }}
            whileHover={{ scale: 1.02 }} whileTap={{ scale: 0.98 }}
            className="w-full py-3 rounded-xl border border-white/10 bg-white/5 text-white/70 text-sm font-medium flex items-center justify-center gap-2 hover:bg-white/10 transition-colors">
